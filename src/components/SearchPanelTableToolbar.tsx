...
import { SearchPanelTableToolbarProps } from "../types";

import SearchInput from "./SearchInput";
import { useSettings } from "../context";
const ITEM_HEIGHT = 48;

export default function SearchPanelTableToolbar({
  table,
  searchInput,
  setSearchInput,
}: SearchPanelTableToolbarProps) {
  ...
  const handleToggleColumnFilterVisibility = (
