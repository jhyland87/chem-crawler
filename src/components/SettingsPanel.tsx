    ...
    <FormGroup>
      ...
      >
        ...
        <ListItem sx={displayHelperOnHover}>
          ...
          <FormHelperText>
            Only show products that ship to your location
          </FormHelperText>
          <FormControlLabel
            control={
              <Switch
                checked={
                  !!settingsContext.settings.location &&
                  settingsContext.settings.shipsToMyLocation
                }
      ...
      >
            ...
            control={
              ...
              >
                <Button
                  ...
                  size="small"
                  variant={
                    settingsContext.settings.popupSize === "small" ?
                      "contained"
                    : "text"
                  }
                >
                ...
                <Button
                  ...
                  size="small"
                  variant={
                    settingsContext.settings.popupSize === "medium" ?
                      "contained"
                    : "text"
                  }
                >
                ...
                <Button
                  ...
                  size="small"
                  variant={
                    settingsContext.settings.popupSize === "large" ?
                      "contained"
                    : "text"
                  }
                >
        ...
        <ListItem sx={displayHelperOnHover}>
          ...
          <FormHelperText id="some-setting-helper-text">
            Disabled by default
          </FormHelperText>
          <FormControlLabel
            control={
